(function() {
  ...
  authOverlay.innerHTML =
    '<p style="color:var(--text-dim);margin-bottom:16px;font-size:0.95rem">🔒 Terminal requires additional authentication</p>' +
    '<div style="display:inline-flex;gap:8px;align-items:center">' +
      '<input type="password" id="shell-pw" placeholder="Terminal password" style="' +
        ...
        'color:var(--text);font-family:inherit;font-size:0.9rem;outline:none;width:220px">' +
      '<button id="shell-auth-btn" style="' +
        'padding:8px 16px;background:var(--green-dim);border:none;border-radius:4px;' +
        'color:#fff;font-family:inherit;font-size:0.9rem;cursor:pointer;font-weight:600;white-space:nowrap">Unlock</button>' +
    '</div>' +
    '<div id="shell-auth-err" style="color:var(--red);font-size:0.85rem;margin-top:10px;display:none">Wrong password</div>';
